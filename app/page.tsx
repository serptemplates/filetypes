                    ...
                    .map(cat => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full px-3 py-2 text-left rounded-md flex items-center gap-2 transition-colors ${isSelected
          ...
          <div ref={letterDropdownRef} className="relative w-full lg:w-80">
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <ChevronDown className={`h-4 w-4 text-gray-400 transition-transform ${letterDropdownOpen ? 'rotate-180' : ''
                  }`} />
              </div>
            </div>
                    ...
                    .map(letter => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-2 py-2 text-center rounded-md transition-colors font-medium ${isSelected
